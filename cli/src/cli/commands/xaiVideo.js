/**
 * `jet-router xai video` — generate a Grok Imagine video through the local
 * jet-router gateway and save the result as an MP4 file.
 *
...
const HELP = `
Usage: jet-router xai video --prompt "..." [options]

Generate a Grok Imagine video via your local jet-router gateway
...
Options:
  ...
  --api-key <key>         jet-router API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-jet-router-connection-id"] || null;
