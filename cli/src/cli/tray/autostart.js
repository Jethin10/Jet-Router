...
const APP_LABEL = "com.jet-router.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when jet-router is currently
 ...
 * SIGTERM to the running process. When the running jet-router cli.js was itself
...
<dict>
    ...
    <string>/tmp/jet-router.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/jet-router.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `jet-router.cmd` lookup that depended on the npm prefix path.
