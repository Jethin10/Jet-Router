...
const cliAppDir = process.env.JET_ROUTER_CLI_APP_DIR || path.join(cliDir, "app");
...
console.log("📦 Building Jet Router CLI package with Next.js...\n");
...
// e.g. .next-cli-build/standalone/jet-router/server.js
...
// Strip better-sqlite3 (native) — it lives in ~/.jet-router/runtime to avoid
...
if (fs.existsSync(betterDir)) {
  ...
  console.log("✅ Stripped better-sqlite3 (lives in ~/.jet-router/runtime)");
}
console.log("");
