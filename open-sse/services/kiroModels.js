 ...
 * into jet-router-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are jet-router fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic jet-router variant set for a single upstream Kiro model.
 *
 ...
 * into jet-router variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
