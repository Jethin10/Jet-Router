 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what jet-router needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a jet-router
...
/**
 * Detect whether a model id refers to a jet-router synthetic agentic variant.
...
/**
 * Detect whether a model id is a jet-router synthetic thinking variant
...
/**
 * Resolve a jet-router model id to the real upstream Kiro model id, plus flags
