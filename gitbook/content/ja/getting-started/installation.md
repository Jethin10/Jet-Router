...
トラブルシューティングのヒント付きのJet Router詳細インストールガイド。
...
どこからでも使用できるようにJet Routerをグローバルインストール:
...
**利点:**
- ✅ どのディレクトリからでも実行
- ✅ シンプルなコマンド: `jet-router`
- ✅ `npm update -g jet-router` で自動更新
