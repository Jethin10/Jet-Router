...
Jet RouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをJet Routerのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはJet Routerモデルにマッピングされる以下のモデルエイリアスをサポート:
...
1. モデル名がJet Routerの設定と一致しているか確認
