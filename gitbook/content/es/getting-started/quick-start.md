...
Pon en marcha Jet Router en 5 minutos y comienza a enrutar solicitudes de IA de forma inteligente.
...
Apunta tu herramienta de codificación a Jet Router:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [desde el dashboard de jet-router]
