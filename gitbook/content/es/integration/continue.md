...
Integra Jet Router con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Continue instalada desde el marketplace de VSCode
- API key de Jet Router desde el [dashboard](https://router.example.com/dashboard)
- Jet Router ejecutándose (local o en la nube)
...
### 2. Agregar configuración de modelo de Jet Router
...
```json
{
  "models": [
    {
      "title": "Jet Router - Claude Opus (Best)",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key-from-dashboard",
      "apiBase": "http://localhost:20128/v1"
    ...
    {
      "title": "Jet Router - Claude Sonnet (Balanced)",
      "provider": "openai",
    ...
    {
      "title": "Jet Router - DeepSeek Chat (Code)",
      "provider": "openai",
    ...
    {
      "title": "Jet Router - Claude Haiku (Fast)",
      "provider": "openai",
...
3. Elige tu modelo preferido de Jet Router
...
```json
{
  "models": [
    {
      "title": "Jet Router - Creative Writer",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key",
      "apiBase": "http://localhost:20128/v1",
...
- Verifica que Jet Router esté corriendo: `curl http://localhost:20128/health`
...
- Selecciona el modelo correcto de Jet Router
...
- Verifica la latencia de red hacia Jet Router
