...
Jet Router es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

Jet Router proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a Jet Router usando estas configuraciones:

**Jet Router local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de Jet Router (cc/*, cx/*, glm/*, etc.)
```

**Jet Router en la nube:**
```
...
**Problema:** No se puede conectar a Jet Router
```bash
# Verifica si Jet Router está corriendo
...
**Solución:**
- Verifica que Jet Router esté corriendo
...
- Verifica la conexión de red a Jet Router
