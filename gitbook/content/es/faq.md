...
Preguntas comunes sobre Jet Router.

---

## ¿Qué es Jet Router?

**Jet Router es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**Jet Router usa una estrategia de precios de 3 niveles:**
...
## ¿Jet Router es gratis?

**Sí, Jet Router en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de Jet Router.**
...
**Jet Router rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿Jet Router funciona con Cursor?

**Sí, pero Cursor requiere un endpoint en la nube.**

**Problema:** Cursor IDE no soporta endpoints en localhost.

**Solución:** Usa el despliegue en la nube de Jet Router:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://router.example.com/v1
...
## ¿Puedo auto-hospedar Jet Router?

**¡Sí! Jet Router soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.jet-router`)
...
**Sí, Jet Router prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.jet-router` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de Jet Router
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](https://github.com/Jethin10/Jet-Router/blob/main/CHANGELOG.md)
- Respalda `~/.jet-router` antes de actualizaciones mayores
...
1. **Reportar bugs:**
   - [GitHub Issues](https://github.com/Jethin10/Jet-Router/issues)
   - Incluye logs de error, pasos para reproducir

2. **Solicitar características:**
   - [GitHub Discussions](https://github.com/Jethin10/Jet-Router/discussions)
   - Describe el caso de uso y los beneficios

3. **Enviar código:**
   ```bash
   # Fork del repo
   git clone https://github.com/YOUR_USERNAME/jet-router.git
   cd jet-router
...
Consulta [CONTRIBUTING.md](https://github.com/Jethin10/Jet-Router/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [Jet Router docs](https://router.example.com/docs)
