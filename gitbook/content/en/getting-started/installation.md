...
Detailed installation guide for Jet Router with troubleshooting tips.
...
Install Jet Router globally to use from anywhere:
...
- ✅ Simple command: `jet-router`
- ✅ Auto-updates with `npm update -g jet-router`
...
3. Data directory created at `~/.jet-router`
...
**Issue:** Jet Router using too much RAM
