...
Common questions about Jet Router.

---

## What is Jet Router?

**Jet Router is an AI model router that maximizes your subscription value and minimizes costs.**
...
**Jet Router uses a 3-tier pricing strategy:**
...
**Yes, Jet Router itself is 100% free and open source.**
...
**Yes! This is Jet Router's core feature.**
...
**Jet Router tracks quota in real-time for all providers:**
...
## Can I self-host Jet Router?

**Yes! Jet Router supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.jet-router`)
...
**Yes, Jet Router prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.jet-router` (or custom `DATA_DIR`)
- No data sent to Jet Router servers
...
**What Jet Router stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What Jet Router does NOT store:**
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/Jethin10/Jet-Router/blob/main/CHANGELOG.md)
- Backup `~/.jet-router` before major updates
...
See [CONTRIBUTING.md](https://github.com/Jethin10/Jet-Router/blob/main/CONTRIBUTING.md) for details.
