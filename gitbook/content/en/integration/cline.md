...
Integrate Jet Router with Cline VSCode extension to route your AI requests through Jet Router's intelligent routing system.

## Prerequisites

- Visual Studio Code installed
- Cline extension installed from VSCode marketplace
- Jet Router running locally or cloud endpoint configured
...
Set the base URL to your Jet Router endpoint:

**For Local Jet Router:**
```
http://localhost:20128/v1
```

**For Cloud Jet Router:**
```
https://router.example.com
```

**Steps:**
1. In the **Base URL** field, enter your Jet Router endpoint
...
3. The key should start with `sk-jet-router-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your Jet Router configuration
...
4. Cline will use Jet Router to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using Jet Router
...
3. Get AI-powered explanations through Jet Router

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use Jet Router to understand context and make changes
...
1. Verify Jet Router is running: `curl http://localhost:20128/health`
...
2. Verify your Jet Router instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check Jet Router logs for any errors

## Advanced Configuration

### Using Cloud Endpoint

To use Jet Router cloud endpoint instead of localhost:

1. In Cline settings, set Base URL to: `https://router.example.com`
2. Make sure you have configured your API key in the Jet Router cloud dashboard
...
## Integration with Jet Router Features

### Model Routing

Jet Router automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, Jet Router automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through Jet Router dashboard:
- Total requests
- Token usage
- Cost per model
