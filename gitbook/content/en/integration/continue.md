...
Integrate Jet Router with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- Jet Router API key from [dashboard](https://router.example.com/dashboard)
- Jet Router running (local or cloud)
...
### 2. Add Jet Router Model Configuration
...
3. Choose your preferred Jet Router model
...
- Check network latency to Jet Router
