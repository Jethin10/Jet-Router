...
Jet Router is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

Jet Router provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to Jet Router using these settings:

**Local Jet Router:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any Jet Router model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to Jet Router
```bash
...
- Check network connection to Jet Router
