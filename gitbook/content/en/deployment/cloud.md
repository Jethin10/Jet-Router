...
Deploy Jet Router on VPS or Docker for remote access and production use.
...
| `DATA_DIR` | `~/.jet-router` | Database and data storage path |
...
Create `/etc/nginx/sites-available/jet-router`:
