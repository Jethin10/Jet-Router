...
Hướng dẫn cài đặt chi tiết cho Jet Router với mẹo troubleshooting.
...
Cài Jet Router toàn cục để dùng ở bất kỳ đâu:

```bash
npm install -g jet-router
```

**Khởi động Jet Router:**
...
**Lợi ích:**
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `jet-router`
- ✅ Auto-update với `npm update -g jet-router`
...
3. Data directory được tạo tại `~/.jet-router`
...
**Vấn đề:** Jet Router dùng quá nhiều RAM
...
# Delete jet-router-related exports
```
