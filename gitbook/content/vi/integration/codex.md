...
Tích hợp Jet Router với OpenAI Codex CLI để định tuyến request API OpenAI qua hệ thống routing thông minh của Jet Router.
...
Jet Router cung cấp các model Codex sau:
...
1. Xác minh API key đúng trong Jet Router dashboard
...
1. Xác minh tên model khớp với cấu hình Jet Router
2. Kiểm tra kết nối provider OpenAI đang hoạt động trong Jet Router dashboard
...
Đảm bảo bạn đã cấu hình API key trong Jet Router cloud dashboard.
