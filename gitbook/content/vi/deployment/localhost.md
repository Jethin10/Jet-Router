...
Chạy Jet Router trên máy cá nhân để phát triển và dùng cá nhân.

---

## 📦 Cài đặt

Cài đặt Jet Router toàn cục qua npm:
...
Khởi động Jet Router với một lệnh duy nhất:
...
Nhấn `Ctrl+C` trong terminal đang chạy Jet Router.
