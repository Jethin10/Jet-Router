    ...
    try {
      ...
      switch (provider) {
        ...
        case "agentrouter": {
          ...
          const isOpenAiFormat = provider === "agentrouter" || provider === "glm-cn" || provider === "alicode" || provider === "alicode-intl" || provider === "alims-intl";
          ...
          if (isOpenAiFormat) {
            ...
            const res = await fetch(cfg.baseUrl, {
              ...
              headers: {
                "x-api-key": apiKey,
                ...(provider === "agentrouter" ? { "Authorization": `Bearer ${apiKey}` } : {}),
                "anthropic-version": "2023-06-01",
                "content-type": "application/json",
                ...(cfg.headers || {}),
              },
