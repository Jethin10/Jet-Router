...
const PROVIDER_NAME = "jet-router";
...
// Build TOML config for Jet Router (openai provider mode)
const buildJetRouterConfig = (baseUrl, apiKey, model) => {
...
// Detect Jet Router by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildJetRouterConfig(baseUrl, apiKey || "sk_jet-router", model);
