...
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/Jethin10/Jet-Router/refs/heads/main/CHANGELOG.md",
  donateUrl: "https://github.com/Jethin10/Jet-Router",
};

// Updater configuration
export const UPDATER_CONFIG = {
  npmPackageName: "jet-router",
  installCmd: "npm i -g jet-router",
  installCmdLatest: "npm i -g jet-router@latest --prefer-online",
